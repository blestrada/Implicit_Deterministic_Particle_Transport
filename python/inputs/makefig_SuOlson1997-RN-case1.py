...
fname = open("SuOlson1997-RN-case1.out", "rb")
...
for i in range(3):
    ...
    plt.plot(xdata, radnrgdens, color=colors[i], marker='o', label=f"Radiation at {times[i]} (IMC)", linewidth=1, markersize='3')

# Now plot benchmark data 
plt.plot(x_bench, rad_benchone[0], 'x--', label=r'Radiation at $\tau$ = 0.1 (Benchmark)', linewidth=1, color='lime')  
plt.plot(x_bench, rad_benchone[2], 'x--', label=r'Radiation at $\tau$ = 1.0 (Benchmark)', linewidth=1, color='orange')
plt.plot(x_bench, rad_benchone[4], 'x--', label=r'Radiation at $\tau$ = 10 (Benchmark)', linewidth=1, color='purple')
...
# Save figure
plt.savefig("SuOlson1997-RN-case1-rad.png", bbox_inches="tight", dpi=900)
plt.show()
...
for i in range(3):
    ...
    plt.plot(xdata, matnrgdens, color=colors[i], marker='o', label=f"Material at {times[i]} (IMC)", linewidth=1, markersize='3')

# Now plot benchmark data for material
plt.plot(x_bench, mat_benchone[0], 'x-', label=r'Material at $\tau$ = 0.1 (Benchmark)', linewidth=1, color='lime')  
plt.plot(x_bench, mat_benchone[2], 'x-', label=r'Material at $\tau$ = 1.0 (Benchmark)', linewidth=1, color='orange')  
plt.plot(x_bench, mat_benchone[4], 'x-', label=r'Material at $\tau$ = 10 (Benchmark)', linewidth=1, color='purple')  
...
plt.savefig("SuOlson1997-RN-case1-mat.png", bbox_inches="tight", dpi=900)
plt.show()
