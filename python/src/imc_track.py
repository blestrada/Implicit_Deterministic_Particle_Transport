...
def run_random():
    ...
    for iptcl in range(len(ptcl.particle_prop)):
        ...
        while True:
            ...
            nrgdep[icell] += nrg - newnrg
            # nrgscattered[icell] += nrg * (1 - exp(-mesh_sigma_t[icell] * dist)) * ((1-mesh_fleck[icell]) * mesh_sigma_a[icell] + mesh_sigma_s[icell]) / mesh_sigma_t[icell]
